...
@UseGuards(RoleGuard) // Apply RoleGuard at the controller level
export class PayrollTrackingController {
  ...
  async createClaim(@Body() createClaimDTO: CreateClaimDTO) {
    return await this.payrollTrackingService.createClaim(createClaimDTO);
  }
  ...
  async getClaimsByEmployeeId(@Param('employeeId') employeeId: string) {
  ...
  async createDispute(@Body() createDisputeDTO: CreateDisputeDTO) {
    return await this.payrollTrackingService.createDispute(createDisputeDTO);
  }
  ...
  @Roles(SystemRole.DEPARTMENT_EMPLOYEE, SystemRole.PAYROLL_SPECIALIST, SystemRole.FINANCE_STAFF, SystemRole.SYSTEM_ADMIN)
  async getDisputesByEmployeeId(@Param('employeeId') employeeId: string) {
  ...
  async createRefund(@Body() createRefundDTO: CreateRefundDTO) {
    return await this.payrollTrackingService.createRefund(createRefundDTO);
  }
  ...
  async getRefundsByEmployeeId(@Param('employeeId') employeeId: string) {
  ...
  @Roles(SystemRole.DEPARTMENT_EMPLOYEE, SystemRole.SYSTEM_ADMIN)
  async getPayslipsByEmployeeId(@Param('employeeId') employeeId: string) {
